...
public class LoanTypeInitializer implements CommandLineRunner{
    ...
    LoanType loanType2=new LoanType().builder().id("itr").label("ITR Loan")
                                   ...
                                   .minAmount(500000).mult(30).build();
